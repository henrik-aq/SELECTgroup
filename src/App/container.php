...
/**
 * We rename or make a shortcut to the CommentController
 */
 ...
 * as $container['your_name']. Inside here we are creating a new CommentsController
 * that will handle adding and removing todos. The CommentsController itself
...
$container['entries'] = function ($c) {
    $entryControllers = new \App\Controllers\EntriesController($c->get('db'));
